-- CreateEnum
CREATE TYPE "UserRole" AS ENUM ('SYSTEM_ADMIN', 'ADMIN', 'EDITOR', 'MEMBER');

-- CreateEnum
CREATE TYPE "ContentType" AS ENUM ('INFO', 'PROCEDURE', 'ANNOUNCEMENT', 'WARNING');
...
-- AddForeignKey
ALTER TABLE "files" ADD CONSTRAINT "files_pageId_fkey" FOREIGN KEY ("pageId") REFERENCES "pages"("id") ON DELETE SET NULL ON UPDATE CASCADE;
